...
"[project]/web/src/app/inventory/[id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function InventoryItemDetails(t0) {
    ...
    if ($[0] !== "1fb6e2e73974bae37477a3155146c6316cd4543a33765b885097e554f8c01afd") {
        for(let $i = 0; $i < 71; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "1fb6e2e73974bae37477a3155146c6316cd4543a33765b885097e554f8c01afd";
    }
    const { params } = t0;
    ...
    let t11;
    if ($[18] !== product.image || $[19] !== product.name) {
        t11 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    const t25 = `px-2 py-1 rounded-full text-xs font-medium ${statusColor}`;
    let t26;
    if ($[40] !== product.status || $[41] !== t25) {
    ...
    let t27;
    if ($[43] !== t15 || $[44] !== t17 || $[45] !== t19 || $[46] !== t21 || $[47] !== t23 || $[48] !== t26) {
    ...
    if ($[53] !== product.dateAdded) {
        ...
        $[53] = product.dateAdded;
        $[54] = t30;
    } else {
        t30 = $[54];
    }
    let t31;
    if ($[55] !== product.lastUpdated) {
    ...
    let t33;
    if ($[60] !== t13 || $[61] !== t27 || $[62] !== t29 || $[63] !== t32) {
...
//# sourceMappingURL=web_src_c81d05c2._.js.map