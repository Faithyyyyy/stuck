...
var __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f40$phosphor$2d$icons$2f$react$2f$dist$2f$csr$2f$Bell$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/web/node_modules/@phosphor-icons/react/dist/csr/Bell.es.js [app-client] (ecmascript)");
...
const NotificationBell = ()=>{
    ...
    if ($[0] !== "a105c5064615402f68e4163b5cbf587bf17e0edabf6ed5bded2b24574fe39d34") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a105c5064615402f68e4163b5cbf587bf17e0edabf6ed5bded2b24574fe39d34";
    }
    let t0;
...
function Sidebar() {
    ...
    if ($[0] !== "16388c9bfddc3a4fa76a508623c1cd5ddc4c4f5c9650c4bae9ee7872ec8d2252") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "16388c9bfddc3a4fa76a508623c1cd5ddc4c4f5c9650c4bae9ee7872ec8d2252";
    }
...
function TopBar(t0) {
    ...
    if ($[0] !== "9c964a7d0a487a97d26c03b5a3936b05c7b68e04c5e6fc2d67b68229e60a8a39") {
        for(let $i = 0; $i < 8; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "9c964a7d0a487a97d26c03b5a3936b05c7b68e04c5e6fc2d67b68229e60a8a39";
    }
    const { rightSide, leftSide, breadCrumb: t1 } = t0;
    t1 === undefined ? "home" : t1;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    let t2;
    if ($[1] !== leftSide) {
        t2 = leftSide ? leftSide : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: " mb-8",
    ...
    let t3;
    if ($[3] !== rightSide) {
        t3 = rightSide && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(TopBar, "zh+HvXX3zxuqMkvNfneES9FE1vU=");
_c = TopBar;
var _c;
...
//# sourceMappingURL=web_src_cb1bc089._.js.map